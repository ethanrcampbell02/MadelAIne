import torch
import numpy as np
from MadelAIneNN import MadelAIneNN

from tensordict import TensorDict
from torchrl.data import TensorDictReplayBuffer, LazyMemmapStorage

class MadelAIneAgent:
    def __init__(self,
                 input_dims,
                 num_actions,
                 lr=0.00025,
        ...
        # Networks
        self.online_network = MadelAIneNN(input_dims, num_actions)
        self.target_network = MadelAIneNN(input_dims, num_actions, freeze=True)
